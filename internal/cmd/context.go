...
// Uses ~/.config/gadoo/ on Unix, %APPDATA%\gadoo\ on Windows.
func getConfigPath() (string, error) {
	...
	gadooDir := filepath.Join(configDir, "gadoo")
	return filepath.Join(gadooDir, "contexts.json"), nil
}
...
func GetCurrentContext() (string, connectionConfig, error) {
	...
	if cd.CurrentContext == "" {
		return "", connectionConfig{},
			errors.New("no context set - run 'gadoo context create <name>' and 'gadoo context use <name>'")
	}
